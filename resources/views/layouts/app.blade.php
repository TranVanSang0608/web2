...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ asset('favicon.png') }}">    <!-- Scripts -->
    @if (env('APP_ENV') == 'local')
        @vite(['resources/sass/app.scss', 'resources/js/app.js'])
    @else
        <!-- Multiple fallback options for CSS -->
        <link rel="stylesheet" href="{{ asset('css/app-fallback.css') }}">
        <link rel="stylesheet" href="{{ asset('build/assets/app.css') }}">
        <link rel="stylesheet" href="{{ asset('build/assets/app-fallback.css') }}">
...
<body>
    <div id="app">
        ...
        </main>        <footer class="footer mt-auto py-3 bg-light border-top">
